...
insert into user values (1, 'prvi@k.com', 'user1', 'User1', 'Suruser1', 'username1', 1, 1);
insert into user values (2, 'drugi@p.com', 'user2', 'User2', 'Suruser2', 'username2', 1, 1);
insert into user values (3, 'treci@p.com', 'user3', 'User3', 'Suruser3', 'username3', 1, 1);
insert into user values (4, 'cetvrti@p.com', 'user4', 'User4', 'Suruser4', 'username4', 1, 1);
insert into user values (5, 'peti@p.com', 'User5', 'user', 'Suruser5', 'username5', 1, 1);
